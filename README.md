...
In addition to performing pairwise comparisons, it might be sensible to compute quantities such as P(|Q₁ - ω| < |Q₂ - ω| ∧ |Q₁ - ω| < |Q₃ - ω|), i.e., the probability that linear model parameter Q deviates from the ideal value ω less for modality 1 than for modalities 2 and 3. This could be generalized to an arbitrary number of modalities as Pᵢ = P(|Qᵢ - ω| < |Qⱼ - ω| ∀ i ≠ j). However, this work is left as an exercise for the reader.
